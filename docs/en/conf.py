...
project = u'Distributed E-Maj'
copyright = u'2026-, Dalibo'
...
latex_documents = [
    (master_doc, 'Dist_emaj.tex', u'Distributed E-Maj Documentation',
...
man_pages = [
    (master_doc, 'dist_emaj', u'Distributed E-Maj Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Distributed E-Maj', u'Distributed E-Maj Documentation',
     author, 'Distributed E-Maj', 'One line description of project.',
     'Miscellaneous'),
]
